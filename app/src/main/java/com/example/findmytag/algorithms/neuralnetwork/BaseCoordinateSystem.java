...
/**
 * This base coordinate system is used for both mapping and testing (target is WiFi AP for mapping and user for testing).
...
public class BaseCoordinateSystem {
    ...
    public BaseCoordinateSystem(double targetX, double targetY, Map<Coordinate, Integer> inputPositionList) {
        this.targetPosition = new Coordinate(targetX, targetY);
